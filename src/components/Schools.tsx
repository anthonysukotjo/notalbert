        ...
        <div style={schoolStyle}>
          <button className="btn default">
            <a href={link}>
              <h4>
                {" "}
                <strong> {code} </strong> Non-Credit Tisch School of the Arts
              </h4>
            </a>
          </button>
        </div>
      ...
      <div className="row">
        <div className="col">
          ...
          <div className=" text-left">
            <SchoolComponentList
              Boolean={schoolList.schoolLoading}
              Array={schoolList.data.undergraduateSchoolList}
            />
            <SchoolComponentList
              Boolean={schoolList.schoolLoading}
              Array={schoolList.data.otherSchoolList}
            />
          </div>
        </div>
        <div className="col">
          ...
          <div className=" text-left">
            <SchoolComponentList
              Boolean={schoolList.schoolLoading}
              Array={schoolList.data.graduateSchoolList}
            />
          </div>
        </div>
      </div>
