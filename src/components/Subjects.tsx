...
const SubjectComponentList =({Boolean: loading, Array: data, String: school})=>{
    ...
    for (let i = 0 ; i < data.length; i++){
        ...
        <div style={subjectStyle}>
            <button className='btn default'>
                <a href = {link}>
                    <h4 > <strong> {subjectCode} </strong> {subjectName}</h4>
                </a>
            </button>
        </div>
        );
        ...
        <div className='row'>
            ...
            <div className='col'>
                <div className=' text-left'>
                    ...
                    <SubjectComponentList Boolean={subjectList.loading} Array={subjectList.data.firstHalfList} String = {schoolCode}/>
                </div>
            </div>
            <div className='col'>
                    <div className=' text-left'>

                        <SubjectComponentList Boolean={subjectList.loading} Array={subjectList.data.secondHalfList}  String = {schoolCode}/>
                    </div>
            </div>
